...
*/
$.fn["toggles"]=function(options){options=options||{};var opts=$.extend({"drag":true,"click":true,"text":{"on":"ON","off":"OFF"},"on":false,"val":"","onVal":"1","offVal":"0","animate":250,"transition":"ease-in-out","checkbox":null,"field":this,"clicker":null,"width":50,"height":20,"type":"compact"},options);var selectType=opts["type"]=="select";if(opts["val"].length&&opts["val"]==opts["onVal"])opts["on"]=true;opts["checkbox"]=$(opts["checkbox"]);opts["field"]=$(opts["field"]);if(opts["clicker"])opts["clicker"]=
